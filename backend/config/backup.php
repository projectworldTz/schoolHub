...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => Str::slug(env('APP_NAME', 'schoolhub')),
        ...
        'destination' => [
            ...
            /*
             * The disk names on which the backups will be stored. GCS is a
             * separate provider/account from Truehost, so a compromised or
             * failing web server can't also wipe out the backups.
             */
            'disks' => [
                env('BACKUP_DISK', 'gcs'),
            ],
